                        ...
                        <nav className="offcanvas-menu-nav mobile-menu">
                            <ul className="navbar-nav">
                                ...
                                <li className="nav-item"><a className="nav-link" href="#">Pages</a>
                                    ...
                                    <Link to="/Shopdetails"> <a className="dropdown-item" href="">Shop Details</a></Link>
                                    <Link to="/Shopingcart">  <a className="dropdown-item" href="">Shopping Cart</a></Link>
                                ...
                                <div className="collapse navbar-collapse" id="navbarNav">
                                    <ul className="navbar-nav mx-auto">
                                        ...
                                        <li className="nav-item dropdown">
                                            ...
                                            <Link to="/Shopdetails"> <a className="dropdown-item" href="">Shop Details</a></Link>
                                            <Link to="/Shopingcart">  <a className="dropdown-item" href="">Shopping Cart</a></Link>
                                            <Link to="/Checkout">  <a className="dropdown-item" href="./checkout.html">Check Out</a></Link>
